...
import com.hotel.HH.Service.ReservationService;
...
//	수정
	...
	public String ReservationCancel(HttpSession session) {
		service.ReservationDelete((String) session.getAttribute("m_id"));
		return "/index";
	}
	...
	public boolean PasswordCheck(@RequestParam("m_id") String m_id, @RequestParam("m_password") String m_password) {
		...
		if (SearchPW.equals(m_password)) {
			service.ReservationDelete(m_id);
			return true;
		} else
			return false;
	}
