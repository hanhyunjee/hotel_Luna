...
<!--  -->
	...
	<script>
		function initialize() { //맵을 초기화 해주기위한 함수 
			...
			var markerTitle	= "호텔 루나"; // 현재 위치 마커에 마우스를 오버을때 나타나는 정보
			var markerMaxWidth	= 600; // 마커를 클릭했을때 나타나는 말풍선의 최대 크기
			
			// 말풍선 내용
			var contentString	= '<div>' +
			'<h2>호텔 루나</h2>'+
			'<p>환상의 섬 제주도 중문단지에 위치한 호텔 루나는 <br>500개의 객실을 갖춘 한국 최고의 리조트 호텔입니다.<br />' +
		...
		<hr>
		  ...
		  <div class="container-fluid" style="background-color:#eeeeee; border:2px solid #E6E6E6">
		   		...
		   		<div class="col-md-12">
			   		<div class="col-md-6" >
			   		<p>
			   			<h3 class="text-center">호텔 루나</h3>
			   		</div>
			   			<div class="col-md-6">
				   			<h6 style="margin-top:20px">제주특별자치도 서귀포시 중문관광로 72번길 35 호텔 루나</h6>
    ...
    <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
      <div class="panel-body">
       	<p> 공항 리무진 Info.</p>
			...
			- 소요시간: 약 50분<br>
			- 이용요금: 공항↔호텔 루나 성인 : 4,500원(편도) / 중,고등 : 3,600원(편도) / 초등 : 2,300원(편도)<br>
