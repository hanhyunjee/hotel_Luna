				...
				<div class="container clearfix">
					...
					<nav id="primary-menu">
						...
						<ul class="">
							...
							<li class="current"><a href="<c:url value="/QnA/QnAList2"/>"><div>고객의
										소리</div></a></li>
							<c:choose>
				...
				<div class="container clearfix">
					...
					<div class="postcontent nobottommargin">
						...
						<form class="nobottommargin" id="template-contactform"
							name="template-contactform" action="sendemail.jsp" method="post">

							<div class="form-process"></div>

							<div class="col_one_third">
								<label for="template-contactform-name">아이디<small>*</small></label>
								<input type="text" id="template-contactform-name"
									name="template-contactform-name" value="${m_id}"
									class="sm-form-control required" disabled />
							</div>
							<div class="col_one_third col_last">
								<label for="template-contactform-service">질문유형</label> <select
							...
							<%-- <div class="col_one_third">
                                ...
                                <input type="email" id="template-contactform-email" name="template-contactform-email" value="${memberDTO.m_userEmail}" class="required email sm-form-control" disabled />
                            </div> --%>
							...
							<div class="col_full">
								<button class="btn button nomargin" type="submit"
									...
									name="template-contactform-submit" value="submit">접수</button>
							</div>
					...
					<div class="sidebar col_last nobottommargin">
						...
						<address>
							<strong>Address:</strong><br> 63535, 제주특별자치도 서귀포시 중문관광로
							72번길, 호텔 루나.
						</address>
						<strong>Phone:</strong> (341) 457 432678<br> <strong>Fax:</strong>
						(341) 457 538478<br>
				...
				<div class="footer-widgets-wrap clearfix">
					...
					<div class="col_two_third">
						...
						<div class="widget clearfix">
							...
							<h3>
								(주)호텔 루나 <span>02-1544-1111</span>
							</h3>
									...
									<div class="col-md-6 bottommargin-sm">
										...
										<div class="widget_links clearfix">
											<ul>
												...
												<li><a href="<c:url value="/hotel-About-Us"/>"><div>호텔소개</div></a></li>
												<li><a href="<c:url value="/Location"/>"><div>호텔위치</div></a></li>
												<li><a href="<c:url value="/QnA/QnAList2"/>"><div>고객의
															소리</div></a></li>
											</ul>
										</div>
									</div>
				...
				<div class="container clearfix">
					...
					<div class="col_half">
						<img src="images/logo/footer-logo.png" alt=""
							...
							class="footer-logo retina-logo"> Copyright &copy; 2020
