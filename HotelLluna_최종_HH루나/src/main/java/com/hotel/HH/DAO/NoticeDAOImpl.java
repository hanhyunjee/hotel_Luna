...
public class NoticeDAOImpl implements NoticeDAO {
	...
	private static final String namespace = "com.spring.HH.mybatis.mapper.NoticeMapper";
	...
	// 기웅씨 추가
	public List<NoticeDTO> selectNotice(Map pageMap) throws DataAccessException {
		List<NoticeDTO> noticeList  = sqlSession.selectList(namespace + ".selectNotice", pageMap);
		return noticeList;
	}
	
	// 기웅씨 추가
	public int totalNotice() throws DataAccessException {
		return sqlSession.selectOne(namespace + ".totalNotice");
	}
